...
- (id)parseEngineerWithPath:(NSString *)path error:(NSError *__autoreleasing  _Nullable *)error {
    XAPPathParser *pathParser = [[XAPPathParser alloc] init];
    XAPIPAModel *ipaModel = [[XAPIPAModel alloc] init];
    XAPWorkspaceModel *workspaceModel = [[XAPWorkspaceModel alloc] init];
    XAPArchiveModel *archiveModel = [[XAPArchiveModel alloc] init];
    XAPProjectModel *projectModel = [[XAPProjectModel alloc] init];
    XAPDirectoryParser *directoryParser = [[XAPDirectoryParser alloc] init];
    
    pathParser.nextHandler = archiveModel;
    archiveModel.nextHandler = ipaModel;
    ipaModel.nextHandler = projectModel;
    projectModel.nextHandler = workspaceModel;
    workspaceModel.nextHandler = directoryParser;
    
    id parsedInfo = [pathParser handlePath:path externalInfo:nil error:error];
    return parsedInfo;
}
