...
+ (NSDictionary *)compare:(NSDictionary *)data1 withOtherData:(NSDictionary *)data2
{
    ...
    NSDictionary *dataF1 = [NSKeyedUnarchiver unarchivedObjectOfClass:NSDictionary.class fromData:[NSKeyedArchiver archivedDataWithRootObject:data1 requiringSecureCoding:YES error:nil] error:nil];
    NSDictionary *dataF2 = [NSKeyedUnarchiver unarchivedObjectOfClass:NSDictionary.class fromData:[NSKeyedArchiver archivedDataWithRootObject:data2 requiringSecureCoding:YES error:nil] error:nil];
