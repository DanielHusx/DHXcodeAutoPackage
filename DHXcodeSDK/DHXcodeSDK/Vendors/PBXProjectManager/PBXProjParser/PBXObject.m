...
- (instancetype)initWithObjectId:(NSString *)objId data:(NSDictionary *)data
{
    ...
    if (self)
    {
        ...
        _rawData = [NSKeyedUnarchiver unarchivedObjectOfClass:NSDictionary.class fromData:[NSKeyedArchiver archivedDataWithRootObject:data requiringSecureCoding:YES error:nil] error:nil];
